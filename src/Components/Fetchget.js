        ...
        {selectedCharacter && (
          <Card>
            <CardHeader
              ...
              subheader={selectedCharacter.fullName}
            />
            <CardContent>
              <img
              ...
              />
              <Typography variant="body1">Name: {selectedCharacter.fullName}</Typography>
              ...
              <Typography variant="body1">Full Name: {selectedCharacter.fullName}</Typography>
